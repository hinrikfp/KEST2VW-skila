...
maður getur ekki notað ákveðnar skipanir
...
You can change the read and write permissions for nfts 
...
Tími og dagsetning, Nettenging, Tungumál, opin forrit

### Name a few applications listed in the Start Menu.
Calculator, Calander, Camera, Cortana, Firefox, Mail, Microsoft solitaire Collection, Microsoft Edge

### What are some of the available options?
Pint to start, Uninstall, more

### What are the available options in the Taskbar settings?
Lock the taskbar, Automatically hide taskbar, Taskbar Location

### What happened?
Tveir gluggar opnuðust

### List some examples of system information below.
Tími og dagsetning, Nettenging, Tungumál, hljóð

### What can you do in the Notification & actions Settings window?
Maður getur slökkt á tilkynningum og breytt hverning þær virka

## Lab - Work with Task Manager

### What happened?
Firefox lokaðist alveg

### What options are available?
Expand, switch to, End task Resource Value, Debug, create dump file, go to details, open file location, search online, properties

### What statuses are listed?
forrit í bakgrunninum
